...
P.layers = [ // enabled, biasEnabled, bias, noiseReductionEnabled, noiseReductionThreshold, noiseReductionAmount, noiseReductionIterations
   [true, true, 0.000, true, 5.000, 0.50, 1],
   [true, true, 0.000, true, 2.500, 0.50, 1],
   [true, true, 0.000, true, 1.500, 0.20, 1],
   [true, true, 0.000, false, 3.000, 1.00, 1],
   [true, true, 0.000, false, 3.000, 1.00, 1]
];
...
P.noiseThresholdingAmount = 0.20;
...
P.linear = false;
P.executeOn(view);
    view.window.removeMask();//retrait du masque
    windowMask.forceClose();//fermeture du masque
